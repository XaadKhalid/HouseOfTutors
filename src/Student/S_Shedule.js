...
export default function S_Shedule() {
  ...
  const Set_schedule = async (details, email) => {
    ...
    try
    {
      const response = await fetch(`http://192.168.43.90/HouseOfTutorsAPI_2/api/student/StudentSchedule?details=${details}&email=${email}`, {
        method: 'POST',

...
export default function S_Profile() {
  ...
  return (
    <View style={styles.profilecontainer}>
      <View>
        <Image source={imagebg} resizeMode="center" style={{ height: 200, width: 200, marginBottom: 6 }} />
      </View>
      <View style={styles.inputContainer}>
        <Text style={styles.inputlabel}>Name :</Text>
        <TextInput placeholder={studentObj.sname} placeholderTextColor={'#000'} />
      </View>
      <View style={styles.inputContainer}>
        <Text style={styles.inputlabel}>Email :</Text>
        <TextInput placeholder={studentObj.semail} placeholderTextColor={'#000'} editable={false} />
      </View>
      <View style={styles.inputContainer}>
        <Text style={styles.inputlabel}>Password :</Text>
        <TextInput placeholder={studentObj.spassword} placeholderTextColor={'#000'} />
      </View>
      <View style={styles.inputContainer}>
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.inputlabel}>Father NIC :</Text>
        <TextInput placeholder={studentObj.fcnic} placeholderTextColor={'#000'} editable={false} />
      </View>
    </View>
  );
}
